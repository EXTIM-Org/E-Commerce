...
export function ProductCard({ product, initialIsLiked = false }: ProductCardProps) {
  ...
  return (
    <Link href={`/products/${product.slug}`} className="group block">
      <div className="relative overflow-hidden rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md transition-all duration-300 hover:bg-white/10 hover:border-purple-500/50 hover:shadow-[0_0_30px_rgba(147,51,234,0.3)]">
        ...
        <div className="p-5 flex flex-col gap-3">
          <h3 className="text-lg font-semibold text-gray-100 line-clamp-1 group-hover:text-purple-400 transition-colors">
            {product.name}
          </h3>
