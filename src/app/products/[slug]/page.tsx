...
export default async function ProductDetailPage({ params }: PageProps) {
  ...
  return (
    <main className="min-h-screen py-20 px-6">
      ...
      {/* Reviews Section */}
      <div className="mt-24 max-w-7xl mx-auto border-t border-gray-200 dark:border-white/10 pt-12" id="reviews">
        <h2 className="text-3xl font-black text-gray-900 dark:text-white mb-8">نظرات کاربران</h2>
