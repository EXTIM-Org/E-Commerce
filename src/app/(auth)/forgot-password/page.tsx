  ...
  return (
    <main className="min-h-screen flex items-center justify-center py-20 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-3xl p-8 backdrop-blur-xl shadow-xl dark:shadow-2xl relative z-10">
        ...
        <h1 className="text-3xl font-black text-gray-900 dark:text-white mb-2 tracking-tight">فراموشی رمز عبور</h1>
        <p className="text-gray-600 dark:text-gray-400 mb-8">ایمیل خود را وارد کنید تا لینک بازیابی برای شما ارسال شود.</p>
        
        {state?.success ? (
          <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 p-6 rounded-2xl flex flex-col items-center justify-center text-center gap-4">
            <CheckCircle2 className="w-12 h-12 text-emerald-500" />
            <p className="font-medium text-lg">ایمیل با موفقیت ارسال شد!</p>
            <p className="text-sm opacity-80">لطفاً صندوق ورودی (و همچنین پوشه اسپم) خود را بررسی کنید و روی لینک بازیابی کلیک کنید.</p>
          </div>
        ) : (
