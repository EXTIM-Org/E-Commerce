  ...
  return (
    <main className="min-h-screen flex items-center justify-center py-20 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl shadow-2xl relative z-10">
        ...
        <h1 className="text-3xl font-black text-white mb-2 tracking-tight">خوش آمدید!</h1>
        <p className="text-gray-400 mb-8">برای دسترسی به سبد خرید و پیگیری سفارشات وارد شوید.</p>
        ...
        <form action={formAction} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            <label className="text-sm font-medium text-gray-300" htmlFor="email">ایمیل</label>
            <div className="relative">
              ...
              <input 
                ...
                required
                dir="ltr"
                className="w-full bg-black/20 border border-white/10 rounded-xl py-3 pr-10 pl-4 text-white focus:outline-none focus:border-violet-500 focus:ring-1 focus:ring-violet-500 transition-all text-left"
          ...
          <div className="flex flex-col gap-2">
            <div className="flex justify-between items-center">
              <label className="text-sm font-medium text-gray-300" htmlFor="password">رمز عبور</label>
              <a href="#" className="text-xs text-violet-400 hover:text-violet-300">فراموشی رمز؟</a>
            </div>
            <div className="relative">
              <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
        ...
        <p className="mt-8 text-center text-sm text-gray-400">
          حساب کاربری ندارید؟{' '}
          <Link href="/register" className="text-violet-400 font-bold hover:text-violet-300 transition-colors">
            ثبت‌نام کنید
          </Link>
        </p>
      </div>
